...
// import 'category_slicing_screen.dart';
...
//                   int monthlySalary=int.tryParse(salaryController.text)!;
//                   // SettingCubit settingCubit =SettingCubit.get(context);
//
...
//                           create: (context)=>TransactionCubit()..fetchCategories()..remainingBudget=monthlySalary=monthlySalary,
